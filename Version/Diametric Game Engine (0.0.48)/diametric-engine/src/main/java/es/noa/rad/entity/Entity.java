...
public abstract class Entity {
    ...
    /** Optional animation player (Phase 5). {@code null} ??? fallback marker. */
    ...
    /** @return the animation controller, or {@code null} if none assigned. */
    public AnimationController getAnimationController() { return animationController; }

    /** Attaches (or detaches with {@code null}) an animation controller. */
    public void setAnimationController(final AnimationController controller) {
