...
- **7b** Editor mode toggle + tile palette overlay. ⏳ Pending.
- **7c** Paint / erase operations on the active layer. ⏳ Pending.
- **7d** File dialog for save/load (`JFileChooser`). ⏳ Pending.
